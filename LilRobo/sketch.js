/*
RR1735 Final Project - ITP 1 Sept 2022
*/
...
{       
    background(0,
               min(100, 255-moon.bright),
               min(255, 255-moon.bright));
    noStroke();
    
    //Moon
    fill(255, 255, 0, -moon.bright);
	ellipse(sun.x, sun.y, sun.diameter);
    moon.bright=gameChar_world_x*255/width-100;
    //Sun
    fill(255, 255, 255, moon.bright);
    ellipse(moon.x, moon.y, moon.diameter);
    fill(0, 0, 0, moon.bright);
    ellipse(moon.x-10, moon.y+15,10);
    ellipse(moon.x-20, moon.y-25,7);
    ellipse(moon.x-15, moon.y-15,8);
    ellipse(moon.x+20, moon.y+25,10);
    ellipse(moon.x+30, moon.y-25,7);
    ellipse(moon.x-35, moon.y+25,8);
    ...
    if (flagpole.isReached == false)
                 ...
                 && game_score != collectables.length)
        {
                ...
                text("Collect " + String(lefttoget) + " more token(s) to win!", width/2-175, height/2-100);
