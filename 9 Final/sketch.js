...
{       
    ...
    if (flagpole.isReached == false)
                 ...
                 &&game_score!=collectables.length)
        {
                ...
                text("Collect " + String(lefttoget) + " token more to win!", width/2-175, height/2-100);
...
//create multiple enemies left and right
    ...
    if (gameChar_world_x<-1000 && deathCounterL<10)
        {
            enemies.push(new Enemy(gameChar_world_x-random(450,800), floorPos_y-20,random(200,350)));
            deathCounterL+=1;
        }
    ...
    if (presskeystart == 0)
        {
            ...
            text("WASD/sapce/directional keys",width/2-170, height/2-150);
...
{   win = true;
    ...
    platforms=[];
    var platList=[
                {platX: -650, platY: 70, lenght: 50},
                {platX: -550, platY: 130, lenght: 50},
                {platX: -450, platY: 190, lenght: 50},
                {platX: -350, platY: 250, lenght: 50},
                ...
                {platX: 1200, platY: 350, lenght: 50},
    ...
    enemies=[];
    var enemiesList=[
                    {enemyX: -850, enemyY: 20, spanEnemy: 300},
                    {enemyX: -550, enemyY: 20, spanEnemy: 300},
                    {enemyX: -200, enemyY: 20, spanEnemy: 300},
                    {enemyX: -150, enemyY: 270, spanEnemy: 150},
                    {enemyX: 450, enemyY: 135, spanEnemy: 125},
                    {enemyX: 1025, enemyY: 20, spanEnemy: 300},
                    {enemyX: 1500, enemyY: 20, spanEnemy: 300}
                    ]; 
